...
female_participants = ['Afra', 'Edda', 'Jana', 'Julia', 'Lina', 'Lisa-Marie', 'Maja', 'Melanie',  'Pia',
                       'Shelly', 'Sina', 'Tais']
...
possible_matches = np.delete(possible_matches, [10, 11], axis=1)
print('Remove Duplicates')
df = pd.DataFrame(data=possible_matches)
